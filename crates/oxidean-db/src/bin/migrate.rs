//! Explicit migrate CLI for `OXIDEAN_AUTO_MIGRATE=false` and `make db-switch-dialect` (D-07, D-16).
//!
//! `cargo run -p oxidean-db --bin migrate -- [--assert-empty] [--force-empty]`

use oxidean_db::{redact_url, Database};
