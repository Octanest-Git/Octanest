...
key-files:
  created: [crates/octanest-core/src/package_types.rs, crates/octanest-api/src/packages/rpc.rs]
  modified: [crates/octanest-api/src/rpc.rs, packages/api-client/src/index.ts]
...
coverage:
  - id: D1
    ...
    requirement: PKG-05
    verification: [{ kind: integration, ref: "cargo nextest run -p octanest-api -E test(package_rpc)", status: pass }]
