...
**Plans:** 9/9 executed (gap-closure 07–09 closed G-11.1-15)
...
- [x] `11.1-01-PLAN.md` — Tracer: layout RepoChrome + Packages tab + packages shell (D-QH-01)
- [x] `11.1-02-PLAN.md` — Coverage toolchain + TESTING.md weights 25/40/35 + CI weighted gate (D-QH-02)
- [x] `11.1-03-PLAN.md` — Strip RepoChrome from code-browse leaves (D-QH-01)
...
- [x] `11.1-08-PLAN.md` — Gap G-11.1-15: Admin packages mount + stack-browser /admin/packages + /admin/auth
- [x] `11.1-09-PLAN.md` — Gap G-11.1-15: Full .tsrx route-coverage manifest + CI gate
...
- [x] `22.1-02-PLAN.md` — Fail-closed update hook + clone_bare/fork hooks (D-PKG-02, D-FORK-*)
- [x] `22.1-03-PLAN.md` — SSH receive-pack protection env + SSH smoke (D-PKG-01/03)

**Wave 3** *(blocked on Wave 2 / 22.1-02)*

- [x] `22.1-04-PLAN.md` — Boot repos_dir hook overwrite sweep (D-PKG-04)

**Wave 4** *(blocked on Waves 2–3 packaging)*

- [x] `22.1-08-PLAN.md` — Thorough VERIFICATION for phases 13 and 22 (after packaging)

**Wave 5** *(blocked on Waves 1 + 4 VERIFICATION)*

- [x] `22.1-10-PLAN.md` — PLAT flips, WINDOWS mass-waive, STATE/parallel-tracks refresh
