...
**Plans**: 1/14 plans executed (waves 0–7)
...
- [ ] `08-00-PLAN.md` — Wave 0 RED: pat_rpc + git_smart_http + dialect_pats stubs
...
- [ ] `08-10-PLAN.md` — Classic create + one-time reveal
...
| 8. Git HTTPS & PATs | 1/14 | In Progress|  |
