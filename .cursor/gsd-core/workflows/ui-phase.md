...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-ui-checker.md for instructions.
...
you used. Re-check the user's locked answers, capability guidance (.cursor/rules/, project skills) and
...
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/jesse/wsl-projects/personal/typescript/octanest/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
