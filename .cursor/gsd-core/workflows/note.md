...
- **Global scope**: `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/notes/`)
...
2. Glob `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/notes/` — works in any directory
