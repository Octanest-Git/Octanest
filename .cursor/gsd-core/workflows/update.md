...
for cand in \
  ...
  "/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/bin/gsd-tools.cjs"; do
...
The `GSD_DIR` value emitted by `get_installed_version` (line 4) resolves to the runtime-specific config dir (`/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/`, `~/.gemini/`, `~/.codex/`, etc.), so the script invocation works for every runtime — not just Claude. An unresolved target exits in `get_installed_version` before this step.
...
global: `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
