...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-eval-planner.md for instructions.
