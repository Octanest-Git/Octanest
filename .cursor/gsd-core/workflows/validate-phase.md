...
```
Agent(
  prompt="Read /home/jesse/wsl-projects/personal/typescript/octanest/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/templates/VALIDATION.md`
