...
<required_reading>
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/user-story-template.md
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/spidr-splitting.md
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/spidr-splitting.md`. Briefly:
