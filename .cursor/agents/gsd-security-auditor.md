...
**Verification depth scales with `asvs_level`** (see @/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
