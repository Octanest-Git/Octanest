...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/mcp.json`, so a
...
@/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/ios-scaffold.md
...
@/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes `TDD_MODE=true` (#4011 — MVP not required):** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/home/jesse/wsl-projects/personal/typescript/oxidean/.cursor/gsd-core/templates/summary.md
