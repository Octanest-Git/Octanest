...
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain .cursor/rules/ mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks .cursor/rules/ requires"
...
@/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a .cursor/rules/ convention, or an active capability constraint. If
