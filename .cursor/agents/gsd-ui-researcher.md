...
Use template from `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/jesse/wsl-projects/personal/typescript/octanest/.cursor/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / .cursor/rules/ rule / spec constraint} | {one line} |
